  ...
  return (
    <>
      <PageHero
        ...
        description="Pour des raisons de confidentialité contractuelle, nos références sont présentées de façon anonymisée."
      />

      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {visibles.map((casClient) => (
            <CasClientCard key={casClient.slug} casClient={casClient} />
          ))}
        </div>
      </section>
    </>
